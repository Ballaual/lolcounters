...
function Imprint({ theme, toggleTheme }) {
    return (
        <>
            <Header theme={theme} toggleTheme={toggleTheme} /> {/* Add Header */}
            <div className="impressum">
                <h1>Impressum</h1>
                <p>Angaben gemäß § 5 DDG</p>
                <p>
                    Alexander Ballauf <br />
                    Looker Straße 52<br />
                    42555 Velbert <br />
                </p>
                <p>
                ...
                <p>
                    ...
                    Telefon: 0-0<br />
                    E-Mail: <a href="mailto:admin@ballaual.de">admin@ballaual.de</a>
                </p>
                <p>
